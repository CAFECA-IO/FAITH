      ...
      >
        {isRenaming ? (
          <input
            ...
            className="w-full rounded border border-input-stroke-input bg-input-surface-input-background p-2 text-sm font-normal text-input-text-input-filled outline-none"
          />
        ) : (
          <Button
  ...
  const displayedFolder = (
    <div key={chatFolder.id} className="w-full pb-2 pt-0">
      <div
        ...
        className={cn(
          'flex w-full items-center justify-between gap-2 px-2 text-base font-medium leading-6 tracking-normal text-text-neutral-primary hover:cursor-pointer'
        )}
      >
